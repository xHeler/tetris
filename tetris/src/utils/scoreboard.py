...
class Scoreboard:
    ...
    Attribiutes:
        display_surface: Surface, Main screen surface where all objects will
            displayed.
        font: Font, Font class made by path to font file .ttf extension and font size.
    """
    def __init__(self, font_size = 16, path = FONT_PATH):
        """Constructor

        Set origin display surface and made font object. Get path to font from settings file.
